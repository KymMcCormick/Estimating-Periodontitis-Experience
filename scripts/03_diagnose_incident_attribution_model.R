...
ggsave(
  filename = "outputs/figures/incident_periodontal_attribution_model_diagnostic.png",
...
readr::write_csv(
  incident_summary,
  "outputs/tables/incident_periodontal_attribution_selected_ages.csv"
)

readr::write_csv(
  sensitivity_summary,
  "outputs/tables/incident_periodontal_attribution_leave_one_source_out.csv"
)

ggplot2::ggsave(
  filename = "outputs/figures/incident_periodontal_attribution_leave_one_source_out.png",
