# code/02c_construct_measures_epe.R
...
readr::write_csv(
  analytic_cumulative,
  "data/derived/analytic_dataset_epe.csv"
)

saveRDS(
  analytic_cumulative,
  "data/derived/analytic_dataset_epe.rds"
)

message("Saved: data/derived/analytic_dataset_epe.csv")
message("Saved: data/derived/analytic_dataset_epe.rds")
