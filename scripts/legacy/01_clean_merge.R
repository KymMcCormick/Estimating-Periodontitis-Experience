...
# ---- merge ----
demo_ghb <- demo %>%
  dplyr::left_join(ghb[,-2], by = c("SEQN"))

saveRDS(demo_ghb, "data/derived/demographics_hba1c.rds")
message("Saved: data/derived/demographics_hba1c.rds")
